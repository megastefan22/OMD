...
set genomeRtd $env(RT_TMP)/269390B1350.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {blake512__GB37}]"
...
set genomeName [subst -nocommands -novariables {blake512__GB37}]
