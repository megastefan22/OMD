...
set genomeRtd $env(RT_TMP)/269391D43B0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__157_blake512__GD}]"
...
set genomeName [subst -nocommands -novariables {case__157_blake512__GD}]
