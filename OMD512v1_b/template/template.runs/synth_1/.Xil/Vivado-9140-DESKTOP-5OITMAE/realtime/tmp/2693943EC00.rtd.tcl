...
set genomeRtd $env(RT_TMP)/2693943EC00.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {blake512__GB47}]"
...
set genomeName [subst -nocommands -novariables {blake512__GB47}]
