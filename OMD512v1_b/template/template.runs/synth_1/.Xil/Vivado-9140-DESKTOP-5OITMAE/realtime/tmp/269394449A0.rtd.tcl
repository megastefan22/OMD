...
set genomeRtd $env(RT_TMP)/269394449A0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__168_blake512__GD}]"
...
set genomeName [subst -nocommands -novariables {case__168_blake512__GD}]
